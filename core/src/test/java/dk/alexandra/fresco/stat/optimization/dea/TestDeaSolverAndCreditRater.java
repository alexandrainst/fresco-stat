package dk.alexandra.fresco.stat.optimization.dea;
...
public class TestDeaSolverAndCreditRater extends AbstractDummyArithmeticTest {
  ...
  public void test_DEASolver_2_Sequential_dummy_NoIterations() {
    runTest(
        new DeaSolverTests.RandomDataDeaTest<>(2, 1, 5, 1, DeaSolver.AnalysisType.OUTPUT_EFFICIENCY, new Random(),
            1, true),
  ...
  public void test_DeaSolver_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(5, 2, 10, 1, DeaSolver.AnalysisType.INPUT_EFFICIENCY),
        new TestParameters());
  }

  @Test
  public void test_DeaSolver_3_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(2, 2, 10, 1, DeaSolver.AnalysisType.INPUT_EFFICIENCY),
        new TestParameters().numParties(3));
  }

  @Test
  public void test_DeaSolver_multiple_queries_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(5, 2, 10, 2, DeaSolver.AnalysisType.INPUT_EFFICIENCY),
        new TestParameters());
  }

  @Test
  public void test_DeaSolver_single_input_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(1, 2, 10, 1, DeaSolver.AnalysisType.INPUT_EFFICIENCY),
        new TestParameters());
  }

  @Test
  public void test_DeaSolver_single_input_and_output_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(1, 1, 10, 1, DeaSolver.AnalysisType.INPUT_EFFICIENCY),
        new TestParameters());
  }

  @Test
  public void test_DEASolver_output_efficiency_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(5, 1, 10, 1, DeaSolver.AnalysisType.OUTPUT_EFFICIENCY),
        new TestParameters());
  }

  @Test
  public void test_DEASolver_multiple_queries__output_2_parties() {
    runTest(new DeaSolverTests.RandomDataDeaTest<>(5, 2, 10, 2, DeaSolver.AnalysisType.OUTPUT_EFFICIENCY),
        new TestParameters());
  }
